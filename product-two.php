...
<head>
  ...
  <title>Lenevo Laptop - fAV gADGET</title>
...
<body>
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="product-imgs">
        <div class="img-display">
          <div class="img-showcase">
            <img src="sample/Lenovo-laptop-1.jpg" class="images">
            <img src="sample/Lenovo-laptop-2.jpg" class="images">
            <img src="sample/Lenovo-laptop-3.jpg" class="images">
            <img src="sample/Lenovo-laptop-4.jpg" class="images">
            <img src="sample/Lenovo-laptop-5.jpg" class="images">
          </div>
        </div>
      ...
      <div class="product-content">
        <h3 class="porduct-title-single-prodcut-page">Lenovo IdeaPad S540 10th Gen Intel Core i5 15.6" (39.62cms) Full HD IPS Thin&Light Laptop</h3>
        ...
        <div class="product-price">
          <p class="last-price">Old Price: <span>₹1,2,899</span></p>
          <p class="new-price">New Price: <span>₹78,899(5%)</span></p>
        </div>

        <div class="product-detail">
          <h2>about this item: </h2>
          <p>
            With 40mm Drivers get ready to immerse in HD auditory experience with super extra bass to get
            the day going.

            Plug into your rhythm with style via the wireless Bluetooth headset and carry the vibe wherever
            you go.

            Stay immersed into Nirvana for extended durations with a playtime of up to 8 hours

            Its lightweight and ergonomic design offers the comfort and ease while you listen to your
            favourite artists and have fun

            1 year warranty from the date of purchase
          </p>

          <ul>
            <li>Color: <span>White & Neon</span></li>
  ...
  <div class="container">
    <div class="product-main">
      ...
      <h2 class="title-second feature-pro">Featured Porducts</h2>
